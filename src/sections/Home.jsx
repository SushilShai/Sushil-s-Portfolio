...
const glowVariants = {
  initial : {scale :1 ,y:0 , filter: "drop-shadow(0 0 rgba(0,0,0,0.6))"},
  hover : {
    scale : 1.2 , y : -3 ,
...
export default function Home(){
  const roles = useMemo(() =>["Web Developer" , "Django Developer", "Fullstack Developer", "React Developer"],[])
    ...
    >
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
              ...
              <span className="inline-block w-0.5 ml-1 bg-white animate-pulse align align-middle"
              style={{height:"1em"}}
              ></span>
            </motion.div>
            <motion.h1 
            ...
            >
              I build smooth, intuitive, and high-performance web applications — turning complex requirements into clean, scalable, and reliable user experiences.
            </motion.p>
            ...
            >
              ...
              <a href="" className="px-6 py-3 rounded-full text-lg font-medium text-black bg-white 
                hover:bg-gray-200 shadow-lg hover:scale-105 transition-all">My Resume</a>
            </motion.div>
        ...
        <div className="relative hidden lg:block">
          ...
          <motion.img src={avator} alt="Sushil Shai" 
          className="absolute top-0.5 object-contain select-none pointer-events-none"
          style={{
            right:"-30px" , width : "min(45vw , 780px)"
          }}
