...
import photo3Img from '../assets/photo3.png';
import photo1Img from '../assets/photo1.JPG';
import photo2Img from '../assets/photo2.PNG';

gsap.registerPlugin(ScrollTrigger);

const Projects = () => {
  // ✅ Use imported variables instead of raw strings
  const projects = [
    { image1: boyImg, image2: astraImg },
    { image1: avatarImg, image2: photo3Img },
    { image1: photo1Img, image2: photo2Img },
  ];
    ...
    <section className="h-[275vh] w-full bg-black">
      <div className="p-2 bg-black">
        <div className="pt-[25vh]">
          <h2 className="text-[9.5vw] uppercase text-[#1cd8d2] flex justify-center">
            Projects
          </h2>
        </div>
