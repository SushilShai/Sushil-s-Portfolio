...
// ✅ Import your contact image properly
...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_pmj87kk', 'template_pkaayng', form.current, {
  ...
  return (
    ...
    >
      ...
      <div className="details absolute top-20 left-30 flex flex-col items-center gap-3">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg">
          REACH OUT ME
        </h2>
        ...
        <h4 className="text-5xl text-[#1cd8d2]">hello@sushilshai.com.np</h4>
      ...
      >
        <h2 className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg">
          ANY PROJECT?
        </h2>
